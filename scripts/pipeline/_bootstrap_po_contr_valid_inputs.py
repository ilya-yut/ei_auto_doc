"""Bootstrap input files for SW_10_02_PO_CONT_VAL (PO_CONTR_VALID)."""
...
INPUT = ROOT / "input"
OLD = INPUT / "old"
STEM = "SKN_S_SW_10_02_PO_CONTR_VALID"
STRUCT_NAME = "/SKN/S_SW_10_02_PO_CONTR_VALID"
INDICATOR_ID = "SW_10_02_PO_CONT_VAL"
INDICATOR_NAME = "PO based on contract with long validity"
...
SRC_CODE_GLOB = "Code_*PO_CONT_VAL*"
SRC_AVAIL_GLOB = "Available*PO_CONT_VAL*"
...
def main() -> None:
    ...
    for pat in ["*PO_AGREE_VALID*", "Metadata _SKN_S_SW_10_02_PO_AGREE_VALID*"]:
    ...
    if not src_code or not src_avail:
        raise SystemExit("Missing code or available-fields source for PO_CONT_VAL")
    ...
    extras = {
        ...
        "PERIOD": ["Validity period day threshold", "INT4", "10", "0", "", ""],
        "BSTYP": ["Purchasing document category", "CHAR", "1", "0", "BSTYP", "BSTYP"],
        "BSART": ["Order type", "CHAR", "4", "0", "BSART", "BSART"],
        "LANGU": ["Language", "LANG", "1", "0", "SPRAS", "SPRAS"],
    }
