...
SKN_S_SW_10_02_MAT_MD from Material master data change inputs.
Run from repo root: python scripts/pipeline/_bootstrap_mat_md_change_inputs.py
"""
...
INPUT = ROOT / "input"
OLD = INPUT / "old"
STEM = "SKN_S_SW_10_02_MAT_MD"
STRUCT_NAME = "/SKN/S_SW_10_02_MAT_MD_CHANGE"
INDICATOR_ID = "SW_10_02_MAT_MD_CH"
INDICATOR_NAME = "Material master data change Exception indicator"
SRC_CODE = INPUT / "Code_Material master daa change Exception indicator_SW_10_02_MAT_MD_CH.txt"
SRC_AVAIL = INPUT / "Available fields_Material master daa change Exception indicator_SW_10_02_MAT_MD_CH.xlsx"
