"""Generate 03_response.md and 07_response.md for Alternative payee assigned to vendor (MD Vendors Change Log) EI."""
import openpyxl
...
struct_path = INPUT_DIR / "Structure_Alternative payee assigned to vendor_200025_001386.xlsx"
code_path = INPUT_DIR / "Code_Alternative payee assigned to vendor_200025_001386.txt"
