"""Build 03_response.md and 07_response.md for Deliveries are blocked due to credit problems EI."""
import openpyxl
...
avail = INPUT / "Available fields_Deliveries are blocked due to credit problems_TD_DLV_BLOCK_OBLIGO_SLS_ORG_1200.xlsx"
struct_path = INPUT / "Structure_Deliveries are blocked due to credit problems_TD_DLV_BLOCK_OBLIGO_SLS_ORG_1200.xlsx"
code_path = INPUT / "Code_Deliveries are blocked due to credit problems_TD_DLV_BLOCK_OBLIGO_SLS_ORG_1200.txt"
...
ws = wb["Parameters"]
rows = list(ws.iter_rows(min_row=3, max_row=350, values_only=True))
wb.close()
params = []
for r in rows:
...
struct = list(wb2.active.iter_rows(min_row=1, max_row=300, values_only=True))
wb2.close()
lines7 = [
