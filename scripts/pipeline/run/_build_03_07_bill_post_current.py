"""Build 03_response.md and 07_response.md for Document SD not posted to FI _ 30 days EI (current input paths)."""
import openpyxl
...
avail = INPUT / "Available fields_Document SD not posted to FI _ 30 days_200020_000071.xlsx"
struct_path = INPUT / "Structure_Document SD not posted to FI _ 30 days_200020_000071.xlsx"
code_path = INPUT / "Code_Document SD not posted to FI _ 30 days_200020_000071.txt"
