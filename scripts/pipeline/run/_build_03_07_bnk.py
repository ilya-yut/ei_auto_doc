"""Build 03_response.md and 07_response.md for Bank account country EI."""
import openpyxl
...
avail = INPUT / "Available fields_Bank account country differs from Vendor's country_SW_10_06_BNK_VND_ARP.xlsx"
struct_path = INPUT / "Structure_Bank account country differs from Vendor's country_SW_10_06_BNK_VND_COM_ARP.xlsx"
code_path = INPUT / "Code_Bank account country differs from Vendor's country_SW_10_06_BNK_VND_COM_ARP.txt"
...
intro = "This table lists all configurable input parameters. Users set values for these parameters to filter and control the EI data selection and processing logic."
lines = [
...
struct = list(wb2.active.iter_rows(min_row=1, max_row=80, values_only=True))
wb2.close()
lines7 = [
