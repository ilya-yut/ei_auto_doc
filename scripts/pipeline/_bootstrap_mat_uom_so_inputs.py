...
SKN_S_SW_10_02_MAT_UNIT from Material master UoM per Sales Organization inputs.
Run from repo root: python scripts/pipeline/_bootstrap_mat_uom_so_inputs.py
"""
...
INPUT = ROOT / "input"
OLD = ROOT / "input" / "old"
STEM = "SKN_S_SW_10_02_MAT_UNIT"
STRUCT_NAME = "/SKN/S_SW_10_02_MAT_UNIT"
INDICATOR_ID = "SW_10_02_MAT_UOM_SO"
INDICATOR_NAME = "Material master UoM per Sales Organization"
SRC_CODE = INPUT / "Code_Material master_ UoM per Sales Organization_SW_10_02_MAT_UOM_SO.txt"
SRC_AVAIL = INPUT / "Available fields_Material master_ UoM per Sales Organization_SW_10_02_MAT_UOM_SO.xlsx"
