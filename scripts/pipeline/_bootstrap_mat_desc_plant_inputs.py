"""Bootstrap input files for SW_10_02_MAT_DS_PL_M (MAT_DESC_PLANT)."""
...
INPUT = ROOT / "input"
OLD = INPUT / "old"
STEM = "SKN_S_SW_10_02_MAT_DESC_PLANT"
STRUCT_NAME = "/SKN/S_SW_10_02_MAT_DESC_PLANT"
INDICATOR_ID = "SW_10_02_MAT_DS_PL_M"
INDICATOR_NAME = "Missing Material Description in Plant Language"
...
SRC_CODE_GLOB = "Code_*MAT_DS_PL_M*"
SRC_AVAIL_GLOB = "Available*MAT_DS_PL_M*"
...
def main() -> None:
    ...
    for pat in ["*MAT_DESC_CUST*", "Metadata _SKN_S_SW_10_02_MAT_DESC_CUST*"]:
    ...
    if not src_code or not src_avail:
        raise SystemExit("Missing code or available-fields source for MAT_DS_PL_M")
