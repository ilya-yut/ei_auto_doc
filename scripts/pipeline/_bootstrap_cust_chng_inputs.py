"""Bootstrap input files for SW_10_06_CUST_CHNG (MD_CHNG_LOG)."""
...
INDICATOR_ID = "SW_10_06_CUST_CHNG"
INDICATOR_NAME = "Customers Master General Change Log"
...
SRC_CODE_GLOB = "Code_*CUST_CHNG*"
SRC_AVAIL_GLOB = "Available*CUST_CHNG*"
...
def main() -> None:
    ...
    for pat in ["*LAND_CODE_COMP*", "Metadata _SKN_S_SW_10_06_LAND_CODE_COMP*"]:
    ...
    if not src_code or not src_avail:
        raise SystemExit("Missing code or available-fields source for CUST_CHNG")
    ...
    extras = {
        ...
        "REPETITIVE": ["Repetitive change detection", "CHAR", "1", "0", "", "XFELD"],
        "MANAGE_IN_UTC": ["Manage in UTC", "CHAR", "1", "0", "", "XFELD"],
        "CHANGE_IND": ["Change indicator header", "CHAR", "1", "0", "", ""],
        "CHNGIND": ["Change indicator item", "CHAR", "1", "0", "", ""],
    }
