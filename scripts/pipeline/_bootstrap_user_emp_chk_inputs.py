...
SKN_S_SW_10_08_USER_EMP_CHK from HR SAP User - Employee Association Check inputs.
Run from repo root: python scripts/pipeline/_bootstrap_user_emp_chk_inputs.py
"""
...
INPUT = ROOT / "input"
OLD = INPUT / "old"
STEM = "SKN_S_SW_10_08_USER_EMP_CHK"
STRUCT_NAME = "/SKN/S_SW_10_08_USER_EMP_CHK"
INDICATOR_ID = "SW_10_08_USR_EMP_CHK"
INDICATOR_NAME = "HR SAP User - Employee Association Check"
SRC_CODE = INPUT / "Code_HR_ SAP User - Employee Association Check_SW_10_08_USR_EMP_CHK.txt"
SRC_AVAIL = INPUT / "Available fields_HR_ SAP User - Employee Association Check_SW_10_08_USR_EMP_CHK.xlsx"
