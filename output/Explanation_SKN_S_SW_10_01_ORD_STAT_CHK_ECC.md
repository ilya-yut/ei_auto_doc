# Exception Indicator: ECC Sales order general ( SW_10_01_ORD_ST_CH_E)

## General Overview

This Exception Indicator identifies ECC sales orders that match configurable header, item, and status criteria and, when reference fields are supplied, compares two numeric or amount values on each order line using a comparison operator, optionally converting currencies before evaluation.

This EI serves as an essential control for ECC sales order operations by:

- Enabling detection of orders whose overall processing, delivery, billing, and credit-check status fields require review
- Supporting configurable comparison of two reference fields from sales order header, item, or item-status tables against each other or against threshold values
...
- Enriching results with partner, customer, and organizational context including item-level status from ECC item status records
...
The routine reads sales order header, item, and item-status data, applies dynamic field comparison and currency conversion rules, enriches partner and customer description data, and raises an alert when qualifying rows remain.


## Problem Description

Failure to monitor ECC sales orders against configured status and field-comparison rules creates multiple risks across order fulfillment, billing, credit control, and customer service:
...
- Item-level status exceptions that differ from header status can remain hidden without line-level monitoring
...
- Review flagged orders for overall processing status, compared field values, item and header delivery and billing status, customer, and sales organization
...
| 11 | BLOCK | Indicator: Document preselected for archiving | CHAR | 1 | 0 | BLOCK_VB | BLOCK_VB |
...
| 59 | FORWDAYS | INT4 | 10 | 0 | FORWDAYS | FORWDAYS |  |
...
| 66 | INC_NOT_CONV_CURR | Single-Character Indicator | CHAR | 1 | 0 | CHAR1 | CHAR1 |
...
| 106 | REF_FIELD1 | Numeric fld name 1 for compare |  | 0 | 0 |  |  |
| 107 | REF_FIELD2 | Numeric fld name 2 for compare |  | 0 | 0 |  |  |
...
| 113 | RESULT_COMP2 | Numeric val.(for comp. FIELD2) |  | 0 | 0 |  |  |
| 114 | RFGSK | Total reference stat | CHAR | 1 | 0 | RFGSK | STATV |
| 115 | RFSTK | Reference status | CHAR | 1 | 0 | RFSTK | STATV |
| 116 | RRSTA | Rev. determ. status | CHAR | 1 | 0 | RR_STATUS | STATV |
| 117 | SALES_GRP_DESC | Description | CHAR | 20 | 0 | BEZEI20 | TEXT20 |
| 118 | SALES_OFF_DESC | Description | CHAR | 20 | 0 | BEZEI20 | TEXT20 |
| 119 | SALES_ORG_DESC | Description | CHAR | 20 | 0 | BEZEI20 | TEXT20 |
| 120 | SAPRL | SAP Release | CHAR | 4 | 0 | SAPRL | SAPRL |
| 121 | SPART | Division | CHAR | 2 | 0 | SPART | SPART |
| 122 | SPSTG | Overall blkd status | CHAR | 1 | 0 | SPSTG | STATV |
| 123 | SW_DEST | CHAR | 32 | 0 | RFCDEST | RFCDEST |  |
| 124 | TRSTA | Trns.plan.status | CHAR | 1 | 0 | TRSTA | TRSTA |
| 125 | UEPOS | Higher-level item | NUMC | 6 | 0 | UEPOS | POSNR |
| 126 | UVALL | Header data | CHAR | 1 | 0 | UVALL_UK | STATV |
| 127 | UVALS | Item data | CHAR | 1 | 0 | UVALL_SU | STATV |
| 128 | UVFAK | Header billing data | CHAR | 1 | 0 | UVFAK_UK | STATV |
| 129 | UVFAS | Item billing data... | CHAR | 1 | 0 | UVFAK_SU | STATV |
| 130 | UVK01 | Header reserves 1 | CHAR | 1 | 0 | UVK01 | STATV |
| 131 | UVK02 | Header reserves 2 | CHAR | 1 | 0 | UVK02 | STATV |
| 132 | UVK03 | Header reserves 3 | CHAR | 1 | 0 | UVK03 | STATV |
| 133 | UVK04 | Header reserves 4 | CHAR | 1 | 0 | UVK04 | STATV |
| 134 | UVK05 | Header reserves 5 | CHAR | 1 | 0 | UVK05 | STATV |
| 135 | UVP01 | Item reserves 1 | CHAR | 1 | 0 | UVP01 | STATV |
| 136 | UVP02 | Item reserves 2 | CHAR | 1 | 0 | UVP02 | STATV |
| 137 | UVP03 | Item reserves 3 | CHAR | 1 | 0 | UVP03 | STATV |
| 138 | UVP04 | Item reserves 4 | CHAR | 1 | 0 | UVP04 | STATV |
| 139 | UVP05 | Item reserves 5 | CHAR | 1 | 0 | UVP05 | STATV |
| 140 | UVPAK | Head.data packaging | CHAR | 1 | 0 | UVPAK_UK | STATV |
| 141 | UVPIK | Head. data picking/putaway | CHAR | 1 | 0 | UVPIK_UK | STATV |
| 142 | UVPRS | Pricing | CHAR | 1 | 0 | UVPRS_UK | STATV |
| 143 | UVS01 | Total reserves 1 | CHAR | 1 | 0 | UVS01 | STATV |
| 144 | UVS02 | Total reserves 2 | CHAR | 1 | 0 | UVS02 | STATV |
| 145 | UVS03 | Total reserves 3 | CHAR | 1 | 0 | UVS03 | STATV |
| 146 | UVS04 | Total reserves 4 | CHAR | 1 | 0 | UVS04 | STATV |
| 147 | UVS05 | Total reserves 5 | CHAR | 1 | 0 | UVS05 | STATV |
| 148 | UVVLK | Header delivery data | CHAR | 1 | 0 | UVVLK_UK | STATV |
| 149 | UVVLS | Item delivery data.. | CHAR | 1 | 0 | UVVLS_SU | STATV |
| 150 | UVWAK | Head. data goods mvmt | CHAR | 1 | 0 | UVWAK_UK | STATV |
| 151 | UVWAS | Item data: goods mvmt | CHAR | 1 | 0 | UVWAK_SU | STATV |
| 152 | VALID_ONLY | Single-Character Indicator | CHAR | 1 | 0 | CHAR1 | CHAR1 |
| 153 | VALUE_COMP1 | Value 1 to Compare | CURR | 15 | 2 |  |  |
| 154 | VALUE_COMP2 | Value 2 to Compare | CURR | 15 | 2 |  |  |
| 155 | VBELN | Sales Document | CHAR | 10 | 0 | VBELN_VA | VBELN |
| 156 | VBOBJ | Document object | CHAR | 1 | 0 | VBOBJ | VBOBJ |
| 157 | VBTYP | SD document categ. | CHAR | 1 | 0 | VBTYP | VBTYP |
| 158 | VDATU | Requested deliv.date | DATS | 8 | 0 | EDATU_VBAK | DATUM |
| 159 | VGTYP | Preceding doc.categ. | CHAR | 1 | 0 | VBTYP_V | VBTYP |
| 160 | VKBUR | Sales Office | CHAR | 4 | 0 | VKBUR | VKBUR |
| 161 | VKGRP | Sales Group | CHAR | 3 | 0 | VKGRP | VKGRP |
| 162 | VKORG | Sales Organization | CHAR | 4 | 0 | VKORG | VKORG |
| 163 | VRKME | Sales unit | UNIT | 3 | 0 | VRKME | MEINS |
| 164 | VTWEG | Distribution Channel | CHAR | 2 | 0 | VTWEG | VTWEG |
| 165 | WAERK | Document Currency | CUKY | 5 | 0 | WAERK | WAERS |
| 166 | WAERK_FR | Foreign Currency | CUKY | 5 | 0 |  |  |
| 167 | WAVWR | Cost | CURR | 13 | 2 | WAVWR | WERTV7 |
| 168 | WBSTA | Goods movement stat. | CHAR | 1 | 0 | WBSTA | STATV |
| 169 | WERKS | Plant | CHAR | 4 | 0 | WERKS_EXT | WERKS |
| 170 | ZWERT | OA Target Value | CURR | 13 | 2 | DZWERT | WERT7 |


### Parameter Configuration Guidelines

IMPORTANT: This EI defines 170 parameters in the Parameters Reference Table. Configure parameters that affect selection and alerting; parameters marked **Not in use** are declared in the interface but do not change results for this EI.
...
**INC_NOT_CONV_CURR** (Single-Character Indicator)

Works downstream of the initial read so single-character indicator on INC_NOT_CONV_CURR still participates in row-level deletion rules.
...
Pick confirmation indicates whether the confirmed picked quantities have been verified and finalized in the delivery document.

**KOSTA** (Picking status)

Picking Status indicates the current stage of the picking requirement, showing whether picking has not started, is partially complete, or is fully complete.
...
<mark>Value of Subtotal  transferred from the pricing procedure to calculate intermediate amounts like gross value or specific discounts.</mark>
...
Proof of delivery status on item level indicates the current stage of the Proof of Delivery process for a specific item, showing whether the delivery confirmation has not yet been processed, is partially processed, or is completely processed.
...
**REF_FIELD1 - REF_FIELD2** (Numeric fld name 1 for compare)

Ensures reporting respects numeric fld name 1 for compare constraints carried by REF_FIELD1.
...
**RESULT_COMP1 - RESULT_COMP2** (Numeric val.(for comp. FIELD1))
...
Transportation planning status indicates the current stage of the shipment planning process for a delivery document, showing whether transportation planning has not yet been processed, is partially processed, or is completely processed.
...
<mark>Item reserves 1 - 5 indicate a user-defined status tracking field reserved for customer-specific requirements at the sales or delivery document line item level.</mark>
...
**VALID_ONLY** (Single-Character Indicator)

Mirrors how administrators slice operational lists: single-character indicator (VALID_ONLY) is one lever that shapes which rows are comparable run over run.

**VALUE_COMP1 - VALUE_COMP2** (Value 1 to Compare)

Works downstream of the initial read so value 1 to compare on VALUE_COMP1 still participates in row-level deletion rules.
...
Documents expected operator behavior—foreign currency on WAERK_FR should be set when that dimension is part of the control objective.
...
Separates cross-client noise from in-scope work when oa target value on ZWERT correlates with client or user attributes.
...
**Status selection:** Header overall status fields from the document status table and item-level status fields from the item status table filter orders by processing, delivery, billing, picking, packing, and credit-check state.
...
**Currency conversion:** When **WAERK_FR** is set and compared fields are currency amounts, values are converted to the target foreign currency before comparison.
...
**Item data:** Sales order item and item-status fields are joined with header data so material, quantity, value, and line-level status attributes appear on each returned row.
...
**Use Case 3: Item delivery status with incomplete header processing**

**Purpose:** Review orders with incomplete overall processing and item delivery status indicating lines not fully delivered.
...
|---|---|---|---|---|
| /SKN/S_SW_10_01_ORD_STAT_CHK | ABGRU | Reason for rejection | CHAR(2) | ABGRU |
| /SKN/S_SW_10_01_ORD_STAT_CHK | ABSTA | Release status | CHAR(1) | ABSTA |
| /SKN/S_SW_10_01_ORD_STAT_CHK | ABSTK | Rejection status | CHAR(1) | ABSTK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | AEDAT | Changed on | DATS(8) | AEDAT |
| /SKN/S_SW_10_01_ORD_STAT_CHK | ANGDT | Quotation valid from | DATS(8) | ANGDT_V |
| /SKN/S_SW_10_01_ORD_STAT_CHK | ARKTX | Description | CHAR(40) | ARKTX |
| /SKN/S_SW_10_01_ORD_STAT_CHK | AUART | Sales Document Type | CHAR(4) | AUART |
| /SKN/S_SW_10_01_ORD_STAT_CHK | AUDAT | Document Date | DATS(8) | AUDAT |
| /SKN/S_SW_10_01_ORD_STAT_CHK | BESTK | Confirmed | CHAR(1) | BESTK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | BLOCK | Indicator: Document preselected for archiving | CHAR(1) | BLOCK_VB |
| /SKN/S_SW_10_01_ORD_STAT_CHK | BNDDT | Quotation valid to | DATS(8) | BNDDT |
| /SKN/S_SW_10_01_ORD_STAT_CHK | BP1_CODE | Customer | CHAR(10) | KUNNR |
| /SKN/S_SW_10_01_ORD_STAT_CHK | BP1_FUNCT | Partner Function | CHAR(2) | PARVW |
| /SKN/S_SW_10_01_ORD_STAT_CHK | BP1_NAME | Name | CHAR(35) | NAME1_GP |
| /SKN/S_SW_10_01_ORD_STAT_CHK | BP2_CODE | Customer | CHAR(10) | KUNNR |
| /SKN/S_SW_10_01_ORD_STAT_CHK | BP2_FUNCT | Partner Function | CHAR(2) | PARVW |
| /SKN/S_SW_10_01_ORD_STAT_CHK | BP2_NAME | Name | CHAR(35) | NAME1_GP |
| /SKN/S_SW_10_01_ORD_STAT_CHK | BP3_CODE | Customer | CHAR(10) | KUNNR |
| /SKN/S_SW_10_01_ORD_STAT_CHK | BP3_FUNCT | Partner Function | CHAR(2) | PARVW |
| /SKN/S_SW_10_01_ORD_STAT_CHK | BP3_NAME | Name | CHAR(35) | NAME1_GP |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMGST | Overall CreditStatus | CHAR(1) | CMGST |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPRE | Credit price | CURR(11) | CMPRE |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPRE_FLT | Credit price | FLTP(16) | CMPRE_FLT |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPS0 | Reserve | CHAR(1) | CMPS0 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPS1 | Reserve | CHAR(1) | CMPS1 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPS2 | Reserve | CHAR(1) | CMPS2 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSA | Static check | CHAR(1) | CMPSA |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSB | Dynamic check | CHAR(1) | CMPSB |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSC | Maximum value | CHAR(1) | CMPSC |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSD | Terms of payment | CHAR(1) | CMPSD |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSE | Customer review date | CHAR(1) | CMPSE |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSF | Overdue open items | CHAR(1) | CMPSF |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSG | Oldest open items | CHAR(1) | CMPSG |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSH | Max.dunning level | CHAR(1) | CMPSH |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSI | Financial document | CHAR(1) | CMPSI |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSJ | Expt cred. insurance | CHAR(1) | CMPSJ |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSK | Payment card | CHAR(1) | CMPSK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSL | Reserve | CHAR(1) | CMPSL |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPSM | Obsolete credit data | CHAR(1) | CMPSM |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPS_CM | SAP Credit Management | CHAR(1) | CMPS_CM |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CMPS_TE | Single-Character Indicator | CHAR(1) | CHAR1 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | COMP_OPERATOR | Operator | CHAR(2) | BUCC_OPERATOR |
| /SKN/S_SW_10_01_ORD_STAT_CHK | COSTA | Confirmation status | CHAR(1) | COSTA_D |
| /SKN/S_SW_10_01_ORD_STAT_CHK | CUST_DESC | Name | CHAR(35) | NAME1_GP |
...
| /SKN/S_SW_10_01_ORD_STAT_CHK | DURATION | Duration In Time Units | INT4(10) | /SKN/E_SW_DURATION |
| /SKN/S_SW_10_01_ORD_STAT_CHK | DURATION_UNIT | Duration Unit | CHAR(1) | /SKN/E_SW_DURATION_UNIT |
| /SKN/S_SW_10_01_ORD_STAT_CHK | ERDAT | Created on | DATS(8) | ERDAT |
| /SKN/S_SW_10_01_ORD_STAT_CHK | ERNAM | Created by | CHAR(12) | ERNAM |
| /SKN/S_SW_10_01_ORD_STAT_CHK | ERZET | Time | TIMS(6) | ERZET |
| /SKN/S_SW_10_01_ORD_STAT_CHK | FAKSK | Billing block | CHAR(2) | FAKSK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | FKIVK | Totals status | CHAR(1) | FKIVK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | FKREL | Relevant for Billing | CHAR(1) | FKREL |
| /SKN/S_SW_10_01_ORD_STAT_CHK | FKSAK | Bill.stat.order-rel. | CHAR(1) | FKSAK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | FSSTA | Billing block status | CHAR(1) | FSSTA |
| /SKN/S_SW_10_01_ORD_STAT_CHK | FSSTK | Overall block status | CHAR(1) | FSSTK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | GBSTA | Overall status | CHAR(1) | GBSTA |
| /SKN/S_SW_10_01_ORD_STAT_CHK | GBSTK | Overall status | CHAR(1) | GBSTK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | GUEBG | Valid-from date | DATS(8) | GUEBG |
| /SKN/S_SW_10_01_ORD_STAT_CHK | GUEEN | Valid-to date | DATS(8) | GUEEN |
| /SKN/S_SW_10_01_ORD_STAT_CHK | INC_NOT_CONV_CURR | Single-Character Indicator | CHAR(1) | CHAR1 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KBMENG | Cumul.confirmed qty | QUAN(15) | KBMENG |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KDMAT | Customer Material | CHAR(35) | MATNR_KU |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KLMENG | Cumul.confirmed qty | QUAN(15) | KLMENG |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KOQUA | Pick confirmation | CHAR(1) | KOQUA |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KOSTA | Picking status | CHAR(1) | KOSTA |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KUNNR | Sold-to party | CHAR(10) | KUNAG |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KWMENG | Order Quantity | QUAN(15) | KWMENG |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KWMENG_INT | Natural Number | INT4(10) | INT4 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KZWI1 | Subtotal 1 | CURR(13) | KZWI1 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KZWI2 | Subtotal 2 | CURR(13) | KZWI2 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KZWI3 | Subtotal 3 | CURR(13) | KZWI3 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KZWI4 | Subtotal 4 | CURR(13) | KZWI4 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KZWI5 | Subtotal 5 | CURR(13) | KZWI5 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | KZWI6 | Subtotal 6 | CURR(13) | KZWI6 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | LFGSK | Overall dlv.status | CHAR(1) | LKGSK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | LFREL | Itm relev.for deliv. | CHAR(1) | LFREL_AP |
| /SKN/S_SW_10_01_ORD_STAT_CHK | LFSTK | Delivery status | CHAR(1) | LFSTK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | LIFSK | Delivery block | CHAR(2) | LIFSK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | LSMENG | Required deliv. qty | QUAN(15) | LSMENG |
| /SKN/S_SW_10_01_ORD_STAT_CHK | LSSTA | Delivery block stat. | CHAR(1) | LSSTA |
| /SKN/S_SW_10_01_ORD_STAT_CHK | LSSTK | Over. dlv. blk stat. | CHAR(1) | LSSTK_G |
...
| /SKN/S_SW_10_01_ORD_STAT_CHK | MATNR | Material | CHAR(18) | MATNR |
| /SKN/S_SW_10_01_ORD_STAT_CHK | MEINS | Base Unit of Measure | UNIT(3) | MEINS |
| /SKN/S_SW_10_01_ORD_STAT_CHK | MPROK | Manual price | CHAR(1) | MPROK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | MPROK_DESC | Short text | CHAR(60) | DDTEXT |
| /SKN/S_SW_10_01_ORD_STAT_CHK | MWSBP | Tax amount | CURR(13) | MWSBP |
| /SKN/S_SW_10_01_ORD_STAT_CHK | NETPR | Net price | CURR(11) | NETPR |
| /SKN/S_SW_10_01_ORD_STAT_CHK | NETPR_VAT | Net price | CURR(11) | NETPR |
| /SKN/S_SW_10_01_ORD_STAT_CHK | NETWR | Net value | CURR(15) | NETWR_AP |
| /SKN/S_SW_10_01_ORD_STAT_CHK | NETWR_VAT | Net value | CURR(15) | NETWR_AP |
| /SKN/S_SW_10_01_ORD_STAT_CHK | PDSTA | Proof of delivery status | CHAR(1) | PDSTA |
| /SKN/S_SW_10_01_ORD_STAT_CHK | PKSTA | Packing status | CHAR(1) | PKSTA |
...
| /SKN/S_SW_10_01_ORD_STAT_CHK | RFGSK | Total reference stat | CHAR(1) | RFGSK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | RFSTK | Reference status | CHAR(1) | RFSTK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | RRSTA | Rev. determ. status | CHAR(1) | RR_STATUS |
...
| /SKN/S_SW_10_01_ORD_STAT_CHK | SPSTG | Overall blkd status | CHAR(1) | SPSTG |
| /SKN/S_SW_10_01_ORD_STAT_CHK | TRSTA | Trns.plan.status | CHAR(1) | TRSTA |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UEPOS | Higher-level item | NUMC(6) | UEPOS |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVALL | Header data | CHAR(1) | UVALL_UK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVALS | Item data | CHAR(1) | UVALL_SU |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVFAK | Header billing data | CHAR(1) | UVFAK_UK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVFAS | Item billing data... | CHAR(1) | UVFAK_SU |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVK01 | Header reserves 1 | CHAR(1) | UVK01 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVK02 | Header reserves 2 | CHAR(1) | UVK02 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVK03 | Header reserves 3 | CHAR(1) | UVK03 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVK04 | Header reserves 4 | CHAR(1) | UVK04 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVK05 | Header reserves 5 | CHAR(1) | UVK05 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVP01 | Item reserves 1 | CHAR(1) | UVP01 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVP02 | Item reserves 2 | CHAR(1) | UVP02 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVP03 | Item reserves 3 | CHAR(1) | UVP03 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVP04 | Item reserves 4 | CHAR(1) | UVP04 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVP05 | Item reserves 5 | CHAR(1) | UVP05 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVPAK | Head.data packaging | CHAR(1) | UVPAK_UK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVPIK | Head. data picking/putaway | CHAR(1) | UVPIK_UK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVPRS | Pricing | CHAR(1) | UVPRS_UK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVS01 | Total reserves 1 | CHAR(1) | UVS01 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVS02 | Total reserves 2 | CHAR(1) | UVS02 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVS03 | Total reserves 3 | CHAR(1) | UVS03 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVS04 | Total reserves 4 | CHAR(1) | UVS04 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVS05 | Total reserves 5 | CHAR(1) | UVS05 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVVLK | Header delivery data | CHAR(1) | UVVLK_UK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVVLS | Item delivery data.. | CHAR(1) | UVVLS_SU |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVWAK | Head. data goods mvmt | CHAR(1) | UVWAK_UK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | UVWAS | Item data: goods mvmt | CHAR(1) | UVWAK_SU |
| /SKN/S_SW_10_01_ORD_STAT_CHK | VALID_ONLY | Single-Character Indicator | CHAR(1) | CHAR1 |
| /SKN/S_SW_10_01_ORD_STAT_CHK | VALUE_COMP1 | Value 1 to Compare | CURR(15) |  |
| /SKN/S_SW_10_01_ORD_STAT_CHK | VALUE_COMP2 | Value 2 to Compare | CURR(15) |  |
| /SKN/S_SW_10_01_ORD_STAT_CHK | VBELN | Sales Document | CHAR(10) | VBELN_VA |
| /SKN/S_SW_10_01_ORD_STAT_CHK | VBOBJ | Document object | CHAR(1) | VBOBJ |
| /SKN/S_SW_10_01_ORD_STAT_CHK | VBTYP | SD document categ. | CHAR(1) | VBTYP |
| /SKN/S_SW_10_01_ORD_STAT_CHK | VDATU | Requested deliv.date | DATS(8) | EDATU_VBAK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | VGTYP | Preceding doc.categ. | CHAR(1) | VBTYP_V |
...
| /SKN/S_SW_10_01_ORD_STAT_CHK | WAERK | Document Currency | CUKY(5) | WAERK |
| /SKN/S_SW_10_01_ORD_STAT_CHK | WAERK_FR | Foreign Currency | CUKY(5) |  |
| /SKN/S_SW_10_01_ORD_STAT_CHK | WAVWR | Cost | CURR(13) | WAVWR |
| /SKN/S_SW_10_01_ORD_STAT_CHK | WBSTA | Goods movement stat. | CHAR(1) | WBSTA |
| /SKN/S_SW_10_01_ORD_STAT_CHK | WERKS | Plant | CHAR(4) | WERKS_EXT |
| /SKN/S_SW_10_01_ORD_STAT_CHK | ZWERT | OA Target Value | CURR(13) | DZWERT |
